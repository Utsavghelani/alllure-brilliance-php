...
$totalProductsResult = mysqli_query($conn, "SELECT COUNT(*) as total FROM products WHERE category_id = 4");
...
<?php
// Fetch all products
$productQuery = mysqli_query($conn, "SELECT * FROM products WHERE category_id = 4 LIMIT $limit OFFSET $offset");

// ---------------- PRICE FILTER LOGIC ---------------- //

// Start base WHERE clause (you can change category_id as needed)
$whereClause = "WHERE category_id = 4";
