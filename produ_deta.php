...
if (isset($_GET['product_id']) && is_numeric($_GET['product_id'])) {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            if ($row['photo_type'] == 'thumb') {
                $thumbs[] = $row['image_path'];
            } elseif ($row['photo_type'] == 'main') {
                $main[] = $row['image_path'];
            }
        }
    } else {
        ...
        <?php if(!empty($thumbs)): ?>
            <?php foreach($thumbs as $thumb): ?>
                <div class="swiper-slide stagger-item">
                    <div class="item">
                        <img src="<?php echo htmlspecialchars($thumb); ?>" alt="thumb-product" style="width:100px;">
                    </div>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
...
<div class="swiper tf-product-media-main" id="gallery-swiper-started">
    <div class="swiper-wrapper">
        <?php if(!empty($main)): ?>
            <?php foreach($main as $mainImg): ?>
                <div class="swiper-slide">
                    <a href="<?php echo htmlspecialchars($mainImg); ?>" target="_blank" class="item">
                        <img src="<?php echo htmlspecialchars($mainImg); ?>" alt="main-product" style="width:300px;">
                    </a>
                </div>
            <?php endforeach; ?>
        <?php endif; ?>
