        ...
        <section class="flat-spacing-9">
            <div class="container">
                <div class="flat-title my-0">
                    <span class="title">We are Allur's</span>
                    <p class="sub-title text_black-2">
                        Welcome to Alllur’s, where timeless elegance is always in style. <br class="d-xl-block d-none">
                        Our collection of diamond-studded and gold jewelry celebrates classic beauty with a modern touch. <br
                            class="d-xl-block d-none">
                        Designed to be cherished for a lifetime, each piece is crafted to elevate every moment.<br
                            class="d-xl-block d-none">
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                    ...
                    <div class="tf-content-wrap px-0 d-flex justify-content-center w-100">
                        <div>
                            <div class="heading">Established - 2018</div>
                            <div class="text">
                                Alllur’s is a jewelry brand built on timeless elegance and expert craftsmanship. <br
                                    class="d-xl-block d-none">
                                We specialize in diamond-studded and gold jewelry, <br
                                    class="d-xl-block d-none">
                                blending classic designs with a modern touch <br
                                    class="d-xl-block d-none">
                                From a humble workshop to a trusted name, Alllur’s continues to <br
                                    class="d-xl-block d-none">
                               to create pieces that celebrate beauty, tradition, and individuality. <br
                                    class="d-xl-block d-none">
                ...
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                    <div class="tf-content-wrap px-0 d-flex justify-content-center w-100">
                        <div>
                            ...
                            <div class="text">
                                At Alllur’s, we don’t just create jewelry - we craft stories in gold and diamonds. <br
                                    class="d-xl-block d-none">
                                Each piece is a celebration of grace, strength, and timeless beauty, <br
                                    class="d-xl-block d-none">
                                designed to be worn, loved, and passed on. <br
                                    class="d-xl-block d-none">
                               Our mission is to turn moments into memories and elegance into a lasting legacy <br
                                    class="d-xl-block d-none">
            ...
            <div class="container">
                <div class="bg_grey-2 radius-10 flat-wrap-iconbox">
                    <div class="flat-title lg">
                        ...
                        <div>
                            <p class="sub-title text_black-2">every piece is a promise of perfection.</p>
                            <p class="sub-title text_black-2">Crafted by skilled artisans, our jewelry reflects unmatched quality, attention to detail, and lasting beauty.</p>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper wrap-iconbox lg">
                                    <div class="swiper-slide">
                                        <div class="tf-icon-box text-center">
                                            ...
                                            <div class="content">
                                                <div class="title">Curated Designs</div>
                                                <p class="text_black-2">Our expert designers bring you collections that celebrate timeless trends and seasonal elegance — perfect for elevating your every look.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tf-icon-box text-center">
                                            ...
                                            <div class="content">
                                                <div class="title">Crafted with Precision</div>
                                                <p class="text_black-2">Each piece is meticulously handcrafted using premium materials, ensuring brilliance, durability, and elegance in every detail.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tf-icon-box text-center">
                                            ...
                                            <div class="content">
                                                <div class="title">Refined Simplicity</div>
                                                <p class="text_black-2">Less is truly more. Our designs embrace the art of minimal elegance, making a subtle yet powerful statement.</p>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="mb-canvas-content">
            <div class="mb-body">
                ...
                <div class="mb-other-content">
                    ...
                    <ul class="mb-info">
                        <li>304, diamond appartment mahidharpura,<br> surat 395003 </li>
                        <li>Email: <b>sales@allurs.com</b></li>
                        <li>Phone: <b>+91 97378 47522</b></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="offcanvas offcanvas-start canvas-mb toolbar-shop-mobile" id="toolbarShopmb">
        ...
        <div class="mb-canvas-content">
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="Rings.php" class="tf-category-link mb-menu-link">
                            <div class="image">
                    ...
                    <li class="nav-mb-item">
                        <a href="Necklace.php" class="tf-category-link mb-menu-link">
                            <div class="image">
                    ...
                    <li class="nav-mb-item">
                        <a href="Bracelets.php" class="tf-category-link mb-menu-link">
                            <div class="image">
                    ...
                    <li class="nav-mb-item">
                        <a href="Allurs.php" class="tf-category-link mb-menu-link">
                            <div class="image">
