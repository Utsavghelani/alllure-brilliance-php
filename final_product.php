...
<!-- Collection -->
    ...
    while ($product = mysqli_fetch_array($productQuery)) {
        ...
        // Fetch images for Gold, Silver, Platinum separately
        ...
        foreach ($materials as $material) {
            ...
            if ($photo = mysqli_fetch_array($photoQuery)) {
                $imageData = $photo['image_path'];
                $images[$material] = base64_encode($imageData);
            } else {
                $images[$material] = ''; // fallback or blank if not found
            }
        }
    ?>
        <div class="card-product grid" >
            <div class="card-product-wrapper">
                <a href="product-detail.php?id=<?php echo $product_id; ?>" class="product-img">
                    <!-- Default main image: Gold -->
                    <img class="lazyload img-product" 
                         data-src="data:image/jpg;base64,<?php echo $images['Gold']; ?>" 
                         src="data:image/jpg;base64,<?php echo $images['Gold']; ?>" 
                         alt="Gold Image">

                    <!-- Hover Image: Silver -->
                    <img class="lazyload img-hover" 
                         data-src="data:image/jpg;base64,<?php echo $images['Silver']; ?>" 
                         src="data:image/jpg;base64,<?php echo $images['Silver']; ?>" 
                         alt="Silver Image">
                </a>
            </div>
            <div class="card-product-info">
                <a href="product-detail.php?id=<?php echo $product_id; ?>" class="title link"><?php echo $product_name; ?></a>
                    ...
                    <?php foreach ($materials as $material): ?>
                        <?php if (!empty($images[$material])): ?>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip"><?php echo $material; ?></span>
                                <span class="swatch-value bg_<?php echo strtolower($material); ?>"></span>
                                <img class="lazyload" 
                                     data-src="data:image/jpeg;base64,<?php echo $images[$material]; ?>" 
                                     src="data:image/jpeg;base64,<?php echo $images[$material]; ?>" 
                                     alt="<?php echo $material; ?> Image">
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </ul>
